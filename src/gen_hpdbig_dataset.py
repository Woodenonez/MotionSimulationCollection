...
save_path = os.path.join(root_dir, 'Data/HPDBIG_1t20_train/') # save in folder

past = 4
minT = 1
maxT = 20
sim_time_per_scene = 30 # times
start_node_list = list(range(1,15))

utils_data.save_HPDBIG_data(start_node_list, save_path, sim_time_per_scene, test=False)
