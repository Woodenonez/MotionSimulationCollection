...
map_path = os.path.join(root_dir, 'src', 'dataset_sim_zospital/zospital_sim_original', 'map.pgm')
...
fig.savefig(os.path.join(root_dir, 'src', 'dataset_sim_hospital/zospital_sim_original', 'label.png'))
plt.show()
