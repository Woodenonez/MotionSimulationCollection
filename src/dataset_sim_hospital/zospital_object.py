...
File info:
    ...
    Exe     - [Yes]
File description:
    Single moving object interaction in zospital dataset (ZPD) simulation.
File content:
...
Comments:
    321*321 (16.05m * 16.05m) square area: Everything is proportional to the real size.
'''
...
def return_netgraph():
    nodes = { 
        1:  [28, 44], 2:  [46, 306], 3:  [60, 44], 4:  [60, 10], 5:  [28, 272], 6:  [300, 272], 
        7:  [160, 272], 8:  [160, 306], 9:  [135, 272], 10: [135, 44], 11: [255, 160], 12: [46, 272], 
        13: [242, 44], 14: [242, 10], 15: [300, 44], 16: [300, 160], 17: [135, 150], 18: [255, 150], 
        19: [135, 193], 20: [255, 193], 21: [255, 272], 22: [255, 44]
    }
    edges = [
        (1, 3), (1, 5), (2, 12), (3, 4), (3, 10), (5, 12), (6, 21), 
